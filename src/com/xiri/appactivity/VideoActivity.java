...
//	  private static final String BANNER = "02dad1e59b5431cd9273fdaf5f42c0e4";
	...
	protected void initView() {
		// TODO Auto-generated method stub
	ImageView iv_content=(ImageView) findViewById(R.id.video_content);
...
//			        try {
//			          Ads.init(VideoActivity.this, APP_ID, SECRET_KEY);
//			          return true;
//			        } catch (Exception e) {
...
//			           * add ad views
//			           */
//			     View  bannerView = Ads.createBannerView(VideoActivity.this, BANNER);
...
//			  
	...
	protected void showFisrtDialog() {
		// TODO Auto-generated method stub
		boolean isFirst=LocalApplication.getInstance().sharereferences.getBoolean("video", false);
	      if(isFirst){	showAlertDialog(showString(R.string.app_videos),
			showString(R.string.video_dialog),
			new String[] {showString(R.string.no_dialog), showString(R.string.yes_dialog)}, true, true, null);}
		     LocalApplication.getInstance().sharereferences.edit().putBoolean("video", false).commit();
